...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { description: @wine.description, profile_id: @wine.profile_id, type: @wine.type, wine_id: @wine.wine_id, wine_name: @wine.wine_name, year: @wine.year } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { description: @wine.description, profile_id: @wine.profile_id, type: @wine.type, wine_id: @wine.wine_id, wine_name: @wine.wine_name, year: @wine.year } }
