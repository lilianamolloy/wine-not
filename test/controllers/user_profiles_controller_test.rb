...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post user_profiles_url, params: { user_profile: { bio: @user_profile.bio, dob: @user_profile.dob, first-name: @user_profile.first-name, surname: @user_profile.surname } }
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { bio: @user_profile.bio, dob: @user_profile.dob, first-name: @user_profile.first-name, surname: @user_profile.surname } }
